<tr class="online_player_bit" id="CHAR_ONLINE_<?php print $_cdata['guid']; ?>">
	...
	<td>
		<img height="18" width="18" src="<?php print WoW::$raceIcons[$_cdata['gender']][$_cdata['race']]; ?>" onmouseover="toolTip(this, '<?php print EscapeHtml(WoW::$arrGender[$_cdata['gender']]." ".WoW::$arrRace[$_cdata['race']]); ?>');" alt="" />
	</td>
	
	<td>
		<img height="18" width="18" src="<?php print WoW::$classIcons[$_cdata['class']]; ?>" onmouseover="toolTip(this, '<?php print EscapeHtml(WoW::$arrClass[$_cdata['class']]); ?>');" alt="" />
	</td>
...
$("#CHAR_ONLINE_<?php print $_cdata['guid']; ?>").click(function(){
	char_ajax = $.ajax({
		...
		beforeSend: function(){
			...
			$("#CHAR_DETAILS_<?php print $_cdata['guid']; ?> td").html('<img src="images/loading-small.gif" height="16" width="16" alt="Loading" />');
