...
<div id="newscontainer" style="display: none;"></div>
...
{
$("#newsloader").PageSort({
JSONFile:"includes/json/news.json.php",ElementsPerPage:5,OrderColumn:"date",OrderMethod:"DESC",PagesTableContainer:"#newspagestable",
...
CallAfterLoad: function(JSONData, totalelements, totalpages)
{
	...
	{
		nc_html += '<div class="left_top"></div><div class="left_content"><div class="main_title"><a href="index.php?id=' + JSONData.MDElements[x]['id'] + '">' + JSONData.MDElements[x]['title'] + '</a></div>';
