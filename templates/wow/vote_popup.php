...
<div id="votepopup_popup" style="color: #000000; width: 100%; height: 100%; position: absolute; left: 0px; right: 0px; top: 0px; bottom: 0px; background: repeat transparent; z-index: 99999; display: none;">
	<div style="padding: 5px; margin-top: 100px; width: 470px; margin-left: auto; margin-right: auto; display: block; positon: absolute; background: url(images/wow/gradients/dark.jpg) repeat; border: 1px #000000 solid;">
...
$(document).ready(function(){$("#votepopup_popup").fadeIn(500);});$(".votepopup_close").click(function(){$("#votepopup_modal").hide();$("#votepopup_popup").hide(500);});
</script>